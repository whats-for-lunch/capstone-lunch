 ...
 * such as Laravel and Composer automatically resolve class names and load them. To use it, simply set the configurable
...
spl_autoload_register(function($class) {
     ...
     */
    $prefix = "whatsforlunch\\capstonelunch";
    $baseDir = __DIR__;
    ...
    // seperators with directory separators in the relative class name, append with .php
