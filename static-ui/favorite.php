    ...
    <div class="card-deck">
        ...
        <div class="card bg-warning">
            ...
            <div class="card-body">
                ...
                <p class="card-text">New Mexican Cuisine </p>
        ...
        <div class="card bg-warning">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Coffee & Tea, American (New), Cafes </p>
        ...
        <div class="card bg-warning">
            ...
            <div class="card-body">
                ...
                <p class="card-text">American (New), Breakfast & Brunch, Latin American</p>
