		...
		<div className="card-deck bg-dark">
			...
			<div className="card bg-warning p-1">
				...
				<div className="card-body">
					...
					<p className="card-text"><a href="https://www.yelp.com/biz/slow-roasted-bocadillos-albuquerque-2"
												target="_blank">Bocadillos</a> was brought to my attention by word of mouth. I've been to sandwich shops before but nothing like this one. These items were all unique in style and flavor. The service is is very friendly and your always greeted with a smile. If you want a delicious sandwich I would always recommend Bocadillos as a place to eat.
						</p>
				</div>
				<div className="card-footer">
				</div>
