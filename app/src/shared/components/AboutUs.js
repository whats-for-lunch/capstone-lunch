...
export const AboutUs = () => (
	<body>
		...
		<div className="row justify-content-center">
						...
						<img src="img/120190529_101042_HDR-640x480.jpg" className="img-fluid" alt="whats for lunch crew"/>
					</span>
		</div>
		<div className="container text-white">
			<div className="row justify-content-center sm">
				<h4 className="display-6">"What's for Lunch"</h4>
			</div>
		</div>
		<div className="container text-white ">
